...
this project has c++, golang, java, julia, perl, python, Rscript, ruby, and rust language examples.
...
appear.
## bfbs.f90
The Fortran version of bfbs, like the C++ version, uses the 
<a href="https://www.mpfr.org/">MPFR</a> (arbitrary-precision floating-point) library and the
<a href="https://gmplib.org/">GMP</a> (multiple-precision arithmetic) library code to provide
the basis of all the calculations. This program compiles on Ubuntu 22.04 LTS Linux after
...
standard deviation. The results are produced without any noticeable delay.
## bfbs.R
The
...
## bfbs.swift
The
<a href="https://developer.apple.com/swift/">Swift</a> version of bfbs uses the 
<a href="https://www.mpfr.org/">MPFR</a> (arbitrary-precision floating-point) library and the
<a href="https://gmplib.org/">GMP</a> (multiple-precision arithmetic) library code to provide
the basis of all the calculations. This program compiles
on MacOS after mpfr and gmp are installed with the homebrew package manager. It outputs
minimum, median, maximum and range in addition to sum, mean, sample variance (s²),
sample standard deviation (s) and autocorrelaton coefficient for a lag of 1 (i.e. r(1)).
...
Row: 1
 ...
 Variance s² : 9.000000000000000000000000000000000000018000000000000000000000000000000000000009e+100
 Std. Dev. s : 300000000000000000000000000000000000000300000000000
 Variance σ² : 6.000000000000000000000000000000000000012000000000000000000000000000000000000006e+100
 Std. Dev. σ : 244948974278317809819728407470589139196839697039945.3306530889851325666268849281
Row: 2
 Count       : 3
...
Column: 1
 ...
 Variance s² : 1.000000000000000000000000000000000000002000000000000000000000000000000000000001e+100
...
usage: bfbs.jl [-c COMMENT_CHAR] [-C] [-d DELIMITER_CHAR] [-D] [-e]
               [-H] [-p PRINT_DIGITS] [-P PRECISION] [-R] [-s SKIP]
               [-v] [-V] [-q] [-h] [files...]
...
optional arguments:
  ...
  -q, --quiet           Suppress output of time and version
                        information and over-ride --verbose.
...
Column: Column 1
  ...
  Std. Dev. (s) : 1.0000000000000000000000000000000000000010000000000000000000000000000000000000000e50
...
Variance (s²): 1.000000000000000000000000000000000000002000000000000000000000000000000000000001e+100
Std. Dev. (s): 1.000000000000000000000000000000000000001e+50
Variance (σ²): 6.6666666666666666666666666666666666666800000000000000000000000000000000000000067e+99
Std. Dev. (σ): 8.1649658092772603273242802490196379732279899013315110217696328377522208961642699e+49
...
bfbs.ts processing took 3.38 [mS].
%
```
### fortran
```
...
### go
```
% go run bfbs.go -precision 340 -print_digits 80 test/data.csv
bfbs v0.0.10
Built with Go version: go1.26.0
...
bfbs (go executable) time taken:  337 [uS]
% 
```
### java
```
> java bfbs --precision=80 test/data.csv
bfbs 0v12 (2026-04-19) - Big Decimal Basic Statistics in Java
...
Info: Output in engineering format: false
...
Column 1:
  ...
  Range         : 2.000000000000000000000000000000000000002E+50
  Sum           : 600000000000000000000000000000000000000600000000000
  Variance (s²) : 1.0000000000000000000000000000000000000020000000000000000000000000000000000000010E+100
...
bfbs.java execution time: 110 [mS]
>
```
### perl
```
% perl bfbs.pl --precision 80 ./test/data.csv
bfbs.pl version 0v9 (2026-04-14)
Perl version: v5.34.1
Getopt::Long Version: 2.52
Math::BigFloat Version: 1.999818
Precision: 80 digits, Output Format: Decimal
...
bfbs.pl execution elapsed time: 0.003989 [sec]
%
```
### python
```
...
Column 1:
  ...
  Sum          : 600000000000000000000000000000000000000600000000000
  Variance (s²): 1.0000000000000000000000000000000000000020000000000000000000000000000000000000010E+100
  Std. Dev. (s): 1.0000000000000000000000000000000000000010E+50
  Variance (σ²): 6.6666666666666666666666666666666666666800000000000000000000000000000000000000067E+99
  Std. Dev. (σ): 81649658092772603273242802490196379732279899013315.110217696328377522208961642699
...
Column 3:
  ...
  Variance (σ²): 6.6666666666666666666666666666666666666800000000000000000000000000000000000000067E+99
  Std. Dev. (σ): 81649658092772603273242802490196379732279899013315.110217696328377522208961642699
bfbs.py execution time was:    15.836 [mS]
%
```
### Rscript
```
...
Column: 3
  ...
  Variance  : 0.1000000000000000000000000000000000000002000000000000000000000000000000000000001e101
  Std. Dev. : 0.1000000000000000000000000000000000000001e51
bfbs.rb execution time was 0.000842 [sec]
%
```
### rust
```
...
Column 1:
    ...
    Variance (s²): 1.00000000000000000000000000000000000000200000000000000000000000000000000000000100e+100
    Std. Dev. (s): 100000000000000000000000000000000000000100000000000.0000000000
    Variance (σ²): 6.666666666666666666666666666666666666680000000000000000000000000000000000000007e+99
    Std. Dev. (σ): 81649658092772603273242802490196379732279899013315.1102176963
Column 2:
    Count        : 3
    ...
    Variance (s²): 1.0000000000000000000000000000000000000020000000000000000000000000000000000000010e+100
    Std. Dev. (s): 100000000000000000000000000000000000000100000000000.0000000000
    Variance (σ²): 6.66666666666666666666666666666666666668000000000000000000000000000000000000001e+99
    Std. Dev. (σ): 81649658092772603273242802490196379732279899013315.1102176963
Column 3:
    Count        : 3
...
Info: bfbs (tcl) time taken: 0.008000 [sec]
%
```
### Comparison Table
...
| language | version | src lines | exe size | 3x3 time | 1001x1 time | 2113x4 time |
|:--------|:-------:|:---------:|:--------:|:--------:|:-----------:|:-----------:|
