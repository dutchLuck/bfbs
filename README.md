...
bfbs.cpp version 0v6
Compiler version: Apple LLVM 17.0.0 (clang-1700.6.3.2)
MPFR version: 4.2.2
GMP version:  6.3.0
...
./bfbs_cpp (c++ executable) time taken:  0.000484 [sec]
%
```
### deno
```
...
bfbs (go executable) time taken:  456 [uS]
%
```
### java
```
