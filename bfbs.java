...
//
// bfbs.java last updated on Sun Sep 14 23:01:07 2025 by O.H. as 0v3
//
...
//
// Usage; -
//  Usage: java bfbs <precision> [--has-header] [--round=n] <file1.csv> [file2.csv] ...
//
...
public class bfbs {
    ...
    public static void main(String[] args) throws IOException {
        if (args.length < 2) {
            System.err.println("Usage: java bfbs <precision> [--has-header] [--round=n] <file1.csv> [file2.csv] ...");
            return;
        }

        int precision = 0;
        boolean hasHeader = false;
        int roundDigits = -1; // -1 means no rounding
        ...
        for (int i = 1; i < args.length; i++) {
            String arg = args[i];
            if (arg.equalsIgnoreCase("--has-header")) {
                hasHeader = true;
